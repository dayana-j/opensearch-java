...
public final class BulkRequestConverter {
        ...
        switch (operation._kind()) {
            case Index:
                ...
                if (indexOp.document() != null) {
                    bodyBuilder.setObject(
                        com.google.protobuf.ByteString.copyFrom(serializeDocument(indexOp.document(), mapper))
                    );
                }
                break;
            ...
            case Create:
                ...
                if (createOp.document() != null) {
                    bodyBuilder.setObject(
                        com.google.protobuf.ByteString.copyFrom(serializeDocument(createOp.document(), mapper))
                    );
                }
                break;
    ...
    private static org.opensearch.protobufs.SourceConfigParam mapSourceConfigParam(SourceConfigParam source) {
        org.opensearch.protobufs.SourceConfigParam.Builder builder =
            org.opensearch.protobufs.SourceConfigParam.newBuilder();
