...
public class TranslationTest {
    ...
    @Test public void testMapRefreshTrue() { assertEquals(org.opensearch.protobufs.Refresh.REFRESH_TRUE, FieldMappingUtil.mapRefresh(Refresh.True)); }
    @Test public void testMapRefreshFalse() { assertEquals(org.opensearch.protobufs.Refresh.REFRESH_FALSE, FieldMappingUtil.mapRefresh(Refresh.False)); }
    @Test public void testMapRefreshWaitFor() { assertEquals(org.opensearch.protobufs.Refresh.REFRESH_WAIT_FOR, FieldMappingUtil.mapRefresh(Refresh.WaitFor)); }
    @Test public void testMapRefreshNull() { assertEquals(org.opensearch.protobufs.Refresh.REFRESH_UNSPECIFIED, FieldMappingUtil.mapRefresh(null)); }
    @Test public void testMapVersionTypeExternal() { assertEquals(org.opensearch.protobufs.VersionType.VERSION_TYPE_EXTERNAL, FieldMappingUtil.mapVersionType(VersionType.External)); }
    @Test public void testMapVersionTypeExternalGte() { assertEquals(org.opensearch.protobufs.VersionType.VERSION_TYPE_EXTERNAL_GTE, FieldMappingUtil.mapVersionType(VersionType.ExternalGte)); }
    @Test public void testMapVersionTypeNull() { assertEquals(org.opensearch.protobufs.VersionType.VERSION_TYPE_UNSPECIFIED, FieldMappingUtil.mapVersionType(null)); }
    @Test public void testMapOpTypeIndex() { assertEquals(org.opensearch.protobufs.OpType.OP_TYPE_INDEX, FieldMappingUtil.mapOpType(org.opensearch.client.opensearch._types.OpType.Index)); }
    @Test public void testMapOpTypeCreate() { assertEquals(org.opensearch.protobufs.OpType.OP_TYPE_CREATE, FieldMappingUtil.mapOpType(org.opensearch.client.opensearch._types.OpType.Create)); }
    @Test public void testMapOpTypeNull() { assertEquals(org.opensearch.protobufs.OpType.OP_TYPE_UNSPECIFIED, FieldMappingUtil.mapOpType(null)); }
    ...
    @Test public void testConvertUnavailable() { assertTrue(GrpcStatusConverter.convert(new StatusRuntimeException(Status.UNAVAILABLE.withDescription("down"))) instanceof TransportException); }
    @Test public void testConvertDeadline() { assertTrue(GrpcStatusConverter.convert(new StatusRuntimeException(Status.DEADLINE_EXCEEDED)) instanceof TransportException); }
    @Test public void testConvertUnauthenticated() { assertTrue(GrpcStatusConverter.convert(new StatusRuntimeException(Status.UNAUTHENTICATED.withDescription("bad"))) instanceof TransportException); }
    @Test public void testConvertNotFound() { Exception e = GrpcStatusConverter.convert(new StatusRuntimeException(Status.NOT_FOUND.withDescription("x"))); assertTrue(e instanceof OpenSearchException); assertEquals(404, ((OpenSearchException)e).status()); }
    @Test public void testConvertInvalidArg() { Exception e = GrpcStatusConverter.convert(new StatusRuntimeException(Status.INVALID_ARGUMENT.withDescription("x"))); assertTrue(e instanceof OpenSearchException); assertEquals(400, ((OpenSearchException)e).status()); }
    ...
    @Test(expected = OpenSearchException.class) public void testThrowConvertedNotFound() throws TransportException { GrpcStatusConverter.throwConverted(new StatusRuntimeException(Status.NOT_FOUND.withDescription("x"))); }
    ...
    public void testIndexOperationBasic() {
        BulkRequest request = new BulkRequest.Builder().index("test-index")
            .operations(op -> op.index(idx -> idx.id("1").document(new Doc("hello", 42)))).build();
    ...
    public void testCreateOperation() {
        BulkRequest request = new BulkRequest.Builder()
            .operations(op -> op.create(c -> c.id("2").index("idx").document(new Doc("w", 99)))).build();
        org.opensearch.protobufs.BulkRequest proto = BulkRequestConverter.toProto(request, mapper);
    ...
    public void testDeleteOperation() {
        BulkRequest request = new BulkRequest.Builder()
            .operations(op -> op.delete(d -> d.id("3").index("idx"))).build();
        org.opensearch.protobufs.BulkRequest proto = BulkRequestConverter.toProto(request, mapper);
    ...
    public void testUpdateOperation() {
        BulkRequest request = new BulkRequest.Builder()
            .operations(op -> op.update(u -> u.id("4").index("idx").retryOnConflict(3).document(new Doc("u", 1)))).build();
        org.opensearch.protobufs.BulkRequest proto = BulkRequestConverter.toProto(request, mapper);
    ...
    public void testTopLevelRefresh() {
        BulkRequest request = new BulkRequest.Builder().refresh(Refresh.WaitFor)
            .operations(op -> op.delete(d -> d.id("1").index("x"))).build();
    ...
    public void testDocSerialization() {
        BulkRequest request = new BulkRequest.Builder()
            .operations(op -> op.index(idx -> idx.id("1").index("t").document(new Doc("hello world", 42)))).build();
    ...
    public void testBasicSuccessResponse() {
        org.opensearch.protobufs.BulkResponse proto = org.opensearch.protobufs.BulkResponse.newBuilder()
            .setTook(50).setErrors(false)
            .addItems(Item.newBuilder().setIndex(ResponseItem.newBuilder().setXIndex("idx").setXId("1").setStatus(0).setResult("created").setXVersion(1).setXSeqNo(0).setXPrimaryTerm(1).build()).build())
            .build();
    ...
    public void testResponseWithErrors() {
        org.opensearch.protobufs.BulkResponse proto = org.opensearch.protobufs.BulkResponse.newBuilder()
            .setTook(30).setErrors(true)
            .addItems(Item.newBuilder().setIndex(ResponseItem.newBuilder().setXIndex("idx").setXId("1").setStatus(0).setResult("created").build()).build())
            .addItems(Item.newBuilder().setUpdate(ResponseItem.newBuilder().setXIndex("idx").setXId("2").setStatus(3)
                .setError(ErrorCause.newBuilder().setType("mapper_parsing_exception").setReason("failed").build()).build()).build())
            .build();
        BulkResponse resp = BulkResponseConverter.fromProto(proto);
    ...
    public void testAllOperationTypes() {
        org.opensearch.protobufs.BulkResponse proto = org.opensearch.protobufs.BulkResponse.newBuilder().setTook(10).setErrors(false)
            .addItems(Item.newBuilder().setIndex(ResponseItem.newBuilder().setXIndex("i").setXId("1").setStatus(0).setResult("created").build()).build())
            .addItems(Item.newBuilder().setCreate(ResponseItem.newBuilder().setXIndex("i").setXId("2").setStatus(0).setResult("created").build()).build())
            .addItems(Item.newBuilder().setUpdate(ResponseItem.newBuilder().setXIndex("i").setXId("3").setStatus(0).setResult("updated").build()).build())
            .addItems(Item.newBuilder().setDelete(ResponseItem.newBuilder().setXIndex("i").setXId("4").setStatus(0).setResult("deleted").build()).build())
            .build();
        BulkResponse resp = BulkResponseConverter.fromProto(proto);
        assertEquals(OperationType.Index, resp.items().get(0).operationType());
    ...
    public void testResponseWithShards() {
        org.opensearch.protobufs.BulkResponse proto = org.opensearch.protobufs.BulkResponse.newBuilder().setTook(1).setErrors(false)
            .addItems(Item.newBuilder().setIndex(ResponseItem.newBuilder().setXIndex("i").setXId("1").setStatus(0)
                .setXShards(ShardInfo.newBuilder().setTotal(2).setSuccessful(2).setFailed(0).build()).build()).build())
            .build();
        BulkResponse resp = BulkResponseConverter.fromProto(proto);
    ...
    public void testIngestTook() {
        org.opensearch.protobufs.BulkResponse proto = org.opensearch.protobufs.BulkResponse.newBuilder().setTook(100).setErrors(false).setIngestTook(25)
            .addItems(Item.newBuilder().setIndex(ResponseItem.newBuilder().setXIndex("i").setXId("1").setStatus(0).build()).build()).build();
    ...
    public static class Doc {
        ...
        public Doc() {} public Doc(String n, int v) { name = n; value = v; }
