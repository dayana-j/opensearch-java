...
public class GrpcTransport implements OpenSearchTransport {
    ...
    private <TDocument> SearchResponse<TDocument> performSearch(SearchRequest request) throws TransportException {
        ...
        org.opensearch.protobufs.SearchRequest protoRequest =
            org.opensearch.client.transport.grpc.translation.SearchRequestConverter.toProto(request, jsonpMapper);
        ...
        try {
            ...
            return (SearchResponse<TDocument>)
                org.opensearch.client.transport.grpc.translation.SearchResponseConverter.fromProto(
                    protoResponse, jsonpMapper, (Class<TDocument>) Object.class
                );
        } catch (StatusRuntimeException e) {
